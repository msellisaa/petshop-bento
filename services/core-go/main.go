...
func main() {
  ...
  mux.HandleFunc("/delivery/track", deliveryTrackHandler(db))
  mux.HandleFunc("/delivery/track/", deliveryTrackStatusHandler(db))
  mux.HandleFunc("/geo/reverse", reverseGeoHandler)
